...
def read_slope_files(filenames):
    ...
    scipix : numpy.ndarray
        3D array containing maps of science pixels. 1 indicates a
        science pixel, and 0 indicates a reference pixel
    """
...
def find_bad_pix(filenames, noisy_threshold=5, max_saturated_fraction=0.5, max_jump_limit=10,
                 ...
                 rc_fraction_threshold=0.8, low_pedestal_threshold=0.8, high_cr_threshold=0.8,
    ...
    low_ped = low_pedestal_vals > low_pedestal_threshold
